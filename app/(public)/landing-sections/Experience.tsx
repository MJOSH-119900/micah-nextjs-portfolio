          ...
          <div className=" flex items-start gap-5">
            <div className="bg-linear-to-r from-[#0d1b2a86] w-15 h-15 via-[#25a6eb79] to-[#0d1b2a86] flex items-center justify-center rounded-full shrink-0">
              ...
              <div className="flex flex-col items-start justify-start gap-2">
                ...
                <h5 className="text-[#25a6eb]">Freelance / Remote</h5>
                <p className="text-[14px] text-[#94A3B8]">Building modern web applications <br /> with React, Next.js, and Tailwind CSS.</p>
              </div>
          </div>
          ...
          <div className=" flex items-start gap-5">
            <div className="bg-linear-to-r from-[#0d1b2a86] w-15 h-15 via-[#25a6eb79] to-[#0d1b2a86] flex items-center justify-center rounded-full shrink-0">
              ...
              <div className="flex flex-col items-start justify-start gap-2">
                ...
                <h5 className="text-[#25a6eb]">Freelance / Remote</h5>
                <p className="text-[14px] text-[#94A3B8]">Built responsible UX, component <br /> libraries and reusable systems. </p>
              </div>
          </div>
          ...
          <div className=" flex items-start gap-5">
            <div className="bg-linear-to-r from-[#0d1b2a86] w-15 h-15 via-[#25a6eb79] to-[#0d1b2a86] flex items-center justify-center rounded-full shrink-0">
              ...
              <div className="flex flex-col items-start justify-start gap-2">
                ...
                <h4>Web Developer</h4>
                <h5 className="text-[#25a6eb]">Freelance / Remote</h5>
                <p className="text-[14px] text-[#94A3B8]">Built projects using HTML, CSS, <br /> Javascript and PHP. </p>
              </div>
          </div>
          ...
          <div className=" flex items-start gap-5 z-10">
            <div className="bg-linear-to-r from-[#0d1b2a86] w-15 h-15 via-[#25a6eb79] to-[#0d1b2a86] flex items-center justify-center rounded-full shrink-0">
              ...
              <div className="flex flex-col items-start justify-start gap-2">
                <h5>2015 - 2021</h5>
                <h4>Cybersecurity</h4>
                <h5 className="text-[#25a6eb]">Learning & Practice</h5>
