      ...
      <div className="flex items-end justify-between gap-20">
        ...
        <div className="w-[60%] text-[16px] text-[#F8FAFC] flex flex-col gap-2 mt-10">
          ...
          <div className="flex items-center justify-start gap-6 whitespace-nowrap">
            <Link
              href="#"
              className="border-2 border-[#2563EB] bg-[#2563EB] flex items-center gap-3 px-10 py-2 rounded-sm hover:bg-[#07111F] hover:border-2 hover:border-[#2563EB]"
            >
              <button>View My Work</button> <ArrowRightIcon />
            </Link>

            <Link
              href="#"
              className="border-2 border-[#2563EB] flex items-center gap-3 px-10 py-2 rounded-sm hover:bg-[#2563EB]"
            >
              <button>Download CV</button> <DownloadIcon />
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-[40%] flex items-center justify-center relative">
          <Image
            src="/images/image-me2.png"
            alt="MJ logo"
            width={10000}
            height={490}
            className="block h-auto max-w-md overflow-hidden"
          />

          <div className="absolute w-100 h-100 bg-[#0D1B2A] rounded-full shadow-md shadow-[#38BDF8] rotate-180 top-8 right-0 -z-10"></div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-around py-10 ">
          ...
          <div className="flex items-center justify-center gap-10">
            {stats.map((stat: ProfileSummary) => {
              ...
              return (
                <div key={stat.id} className="flex items-center justify-center  text-[#94A3B8] min-w-40 py-2 gap-2">
